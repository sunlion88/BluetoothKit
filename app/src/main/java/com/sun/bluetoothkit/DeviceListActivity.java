...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnRefresh.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Log.d("pairedDevice", "" + pairedDevices.size());
    ...
    public static void goWeb() {
        Uri uri = Uri.parse("https://www.bluetooth.com/");
    ...
    private void SetUUID() {
        ...
        wrapper = new DialogWrapper2(addView);
        wrapper.setEditUUID(Read_LastUUID());
        wrapper.setDefault();
        ...
        diag.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Save_LastUUID(wrapper.getUsrUUID());
